...
@endpush
<div class="w-6/12">
    <svg viewBox="0 0 176 207" version="1.1" xmlns="http://www.w3.org/2000/svg"
         xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
         style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;"><rect
            id="Artboard1" x="0" y="0" width="175.551" height="206.785" style="fill:none;"/>
        <g id="Back-Muscles">
            <g>
                <g id="Trapezius" style="fill:#c2c2c2;">
                    <g>
                        <path
                ...
                <g id="Triceps" style="fill:#c2c2c2;">
                    <path
                ...
                <g id="Forearms" style="fill:#c2c2c2;">
                    <path
                ...
                <g id="Hamstrings" style="fill:#c2c2c2;">
                    <path
        ...
        <g id="Front-Muscles">
            <g id="Deltoids" style="fill:#c2c2c2;">
                <path
            ...
            <g id="Obliques" style="fill:#c2c2c2;">
                <path
            ...
            <g id="Quadriceps" style="fill:#c2c2c2;">
                <path
            ...
            <g id="Abductors" style="fill:#c2c2c2;">
                <path
        ...
        <path id="Back"
              ...
              style="fill:none;stroke:#000;stroke-width:1px;"/></svg>
</div>
<script>
    var colorPalette = [@foreach($colorPalette as $key)
        '{{$key}}',
        @endforeach];

    var volume = [@foreach($volume as $key => $value)
        {{$value}},
        @endforeach];

    var muscles = [@foreach($volume as $key => $value)
        '{{$key}}',
        @endforeach];

    let i = 0;
    muscles.forEach((element) => {
        console.log("Element: " + element + " volume: " + volume[i])
            switch (element) {
                case "Glutes":
                    console.log("Glutes")
                    let element1 = document.getElementById("Abductors")
                    let element2 = document.getElementById("Glutes")
                    element1.style.fill = colorPalette[i];
                    element2.style.fill = colorPalette[i];
                    break;
                case "Shoulders":
                    console.log("Shoulders")
                    let element3 = document.getElementById("Trapezius")
                    let element6 = document.getElementById("Deltoids")
                    element3.style.fill = colorPalette[i];
                    element6.style.fill = colorPalette[i];
                    break;
                case "Core":
                    console.log("Core")
                    let element7 = document.getElementById("Obliques")
                    let element8 = document.getElementById("Abs")
                    element7.style.fill = colorPalette[i];
                    element8.style.fill = colorPalette[i];
                    break;
                case "Back":
                    console.log("Back")
                    let element9 = document.getElementById("Trapezius")
                    let element4 = document.getElementById("Lats")
                    element9.style.fill = colorPalette[i];
                    element4.style.fill = colorPalette[i];
                    break;
                default:
                    let thisElement = document.getElementById(element)
                    thisElement.style.fill = colorPalette[i];
                    console.log(element)
            }
            i++;
        }
