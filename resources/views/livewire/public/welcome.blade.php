        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    <li class="mr-3">
                        <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                           href="/skinfold">Skin Fold Calculator</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                           href="https://blog.dingbat.app">Blog</a>
                    </li>
                </ul>
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <p class="uppercase tracking-loose w-full">Dingbat.app</p>
        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('/img/dashboard_mobile.png')}}">
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img src="{{asset('/img/weekly.png')}}">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('/img/per_exercise_statistics.png')}}">
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img src="{{asset('/img/per_plan_statistics.png')}}">
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        Log rets/reps and track personal bests. Weights are automatically calculated for 1RM plans
                        (nSuns, Wendler etc).
                        <br/>
                    </p>
                </div>
                <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('/img/custom_workouts.png')}}">
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img src="{{asset('/img/skinfold_tests.png')}}">
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        Use the plan wizard to create complex plans from scratch or modify existing plan. You can share
                        plans with friends by making them global!
                        <br/>
                    </p>
                </div>
                <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('/img/plan_creation_wizard.png')}}">
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img src="{{asset('/img/view_goals.png')}}">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('/img/measurement_history.png')}}">
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img src="{{asset('/img/workout_log.png')}}">
    ...
    <footer class="bg-white">
       ...
       -->
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="https://www.facebook.com/dingbatapp/?business_id=301724304925078"
                               class="no-underline hover:underline text-gray-800 hover:text-pink-500">Facebook</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="https://twitter.com/dingbat_app"
